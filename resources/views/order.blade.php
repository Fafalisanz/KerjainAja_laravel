...
<body class="bg-[#f5f6fa] min-h-screen p-6 md:p-10">
    ...
    <div class="max-w-7xl mx-auto space-y-6">
        ...
        {{-- Form Utama dengan Layout 2 Kolom --}}
    ...
    <script>
        // Script Interaktif Pengganti State checked CSS pada Tailwind
