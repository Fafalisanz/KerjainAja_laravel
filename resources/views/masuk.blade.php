...
<body class="bg-gray-50 min-h-screen flex">
    ...
    {{--  SISI KIRI (ILUSTRASI & SAPAAN LOG IN)  --}}
    ...
    {{--  SISI KANAN (FORMULIR AUTENTIKASI MASUK) --}}
    <div class="w-full lg:w-1/2 flex items-center justify-center p-8">
        <div class="w-full max-w-md">
            ...
            {{-- Komponen Notifikasi Pesan Kesalahan / Error Gagal Autentikasi --}}
            @if(session('error'))
            ...
            {{-- Formulir Input Sesi Masuk Pengguna --}}
            ...
            {{-- Tautan Alternatif Menuju Halaman Registrasi Akun Baru --}}
