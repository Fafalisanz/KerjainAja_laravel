...
<body class="bg-gray-50 min-h-screen">
    ...
    {{-- KONTAINER UTAMA RIWAYAT LOG TRANSAKSI USER KLIEN --}}
    <div class="max-w-3xl mx-auto px-4 py-10">

        {{-- Judul Halaman & Sub-Informasi Deskripsi --}}
        <div class="mb-7">
        ...
        {{-- ================= ALUR KONDISI PENGONDISIAN RIWAYAT TRANS-USER ================= --}}
        @if($pesanan->isEmpty())
            
            {{-- Kondisi 1: Tampilan Jika Log Akun Pengguna Belum Memiliki Pesanan Apapun --}}
        ...
        @else
            ...
            @foreach($pesanan as $p)
                <div class="bg-white rounded-2xl shadow-sm border-l-4 border-[#114d4d] p-6 mb-4 hover:-translate-y-1 transition-transform">
                    ...
                    {{-- Baris Tengah: Blok Informasi Durasi, Metode, Dan Kode Seri Invoice --}}
                    ...
                    {{-- Catatan Tambahan Memo Deskripsi Instruksi Kerja yang Diinputkan --}}
                    ...
                    {{-- Baris Bawah: Akumulasi Nominal Tagihan & Tombol Aksi Pembayaran --}}
                    <div class="flex justify-between items-center pt-4 border-t border-gray-100">
                        ...
                        {{-- Pengondisian Dinamis Navigasi Link Pembayaran Invoice Sesuai Status --}}
